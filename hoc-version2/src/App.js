...
import Reviews from '../../hoc-version2/src/Reviews'
import Menu from '../../hoc-version2/src/Menu'

import './Menu.css'
import Article from "../../hoc-version2/src/Article";
  ...
  render () {
    ...
    return (
      <div>
        <Menu />
        <Reviews />
        <Article listOfArticles = {articles} />
      </div>
    )
  }
}
